                ...
                <div className="px-6 py-4 border-b border-border flex items-center justify-between bg-primary/5">
                    <div className="space-y-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                            A comprehensive view of the theme applied to various
                            complex components.
                        </p>
                    </div>
                ...
                <div className="p-6 md:p-8 space-y-10">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {[
                            ...
                            <div
                                key={i}
                                className="p-4 rounded-lg bg-primary/5 border border-border space-y-2 hover:bg-secondary/60 transition-colors duration-500"
                            >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-10">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between">
                                    ...
                                    <BarChart3 className="w-5 h-5 text-muted-foreground hover:bg-primary transition-colors duration-300 hover:text-secondary border-border border hover:border-primary" />
                                </div>
                                <div className="h-32 flex items-end gap-1 pb-2 border-b border-border px-4 mt-16">
                                    {[
                                        1.1, 0.6, 0.9, 1.5, 0.2, 0.98, 1.2, 0.4,
                                        0.9, 0.8, 1.3, 0.6,
                                    ].map((h, i) => (
                                        <motion.div
                                            key={i}
                                        ...
                                        >
                                            <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-popover text-popover-foreground text-[10px] py-1 px-2 rounded opacity-0 group-hover/bar:opacity-100 transition-opacity duration-600 whitespace-nowrap shadow-sm border border-border">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="h-50 border border-border rounded-lg bg-background flex items-center justify-center p-2">
                                        <EvilSankeyChart
                                            data={sankeyData}
                        ...
                        <div className="space-y-8">
                            {/* Form Elements */}
                            <div className="p-4 rounded-lg border border-border bg-primary/5 space-y-4">
                                <h4 className="font-medium text-sm border-b border-border px-2">
                                    Settings
                                </h4>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            {[
                                ...
                                {
                                    title: "New User",
                                    desc: "Alice joined the team.",
                                    time: "5h ago",
                                    color: "bg-primary/10 text-primary",
                                },
                                {
                                    title: "Deployment",
                                    desc: "Production build successful.",
                                    time: "1d ago",
                                    color: "bg-primary/10 text-primary",
                                },
                            ].map((item, i) => (
                                <div
                                    key={i}
                                    className="flex items-start gap-3 p-3 rounded-md border border-border bg-card/50 hover:bg-muted transition-colors duration-500"
                                >
                                    <div
                                        className={`p-1.5 rounded-full mt-1.5 ${item.color}`}
                                    >
                                    ...
                                    <span className="text-[10px] text-muted-foreground ml-auto whitespace-nowrap mt-1">
                                        {item.time}
                                    </span>
                                </div>
                            ))}
